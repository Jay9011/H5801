...
public class DTOBook {
	...
	private float total_amount; //	테이블명: RESERVE 컬럼명: total_amount
	...
	// 매개변수 생성자
	public DTOBook(int p_uid, Date b_sdate, Time b_stime, Time b_etime, int b_term, int b_duration, int b_refund,
