...
public class NoticeList extends NoticeResult{
	
	private List<DTONotice> list;	// 데이터 목록
	...
	public List<DTONotice> getList() {return list;}
	public void setList(List<DTONotice> list) {this.list = list;}
