  ...
  <section class="container section scrollspy" id="reserve">
    <div class="row">
        <div class="col s6 14">
            ...
            <p>Holic 독서실은 '갤러리형의 차별화된 독서실'로, 공부하는 행위와 수험생에 대한 해석을 공간적으로 풀었습니다.
사람들마다 공부하는 방법과 성향, 시험기간이나 목표, 공부가 잘되는 시간대 등도 다르다고 생각하여
좌석들을 그룹지어 각기 다른 개성을 가진 공부공간을 만들었습니다.</p>
        </div>
        <div class="col s6 16 offset-12">
            <ul class="tabs">
                <li class="tab col s6">
                    <a href="#photography" class="amber-text text-darken-3">StudyCenter</a>
                </li>
                <li class="tab col s6">
                    <a href="#editing" class="amber-text text-darken-3">StudyRoom</a>
                </li>
            </ul>
            <div class="col s12" id="photography">
                <p class="flow-text amber-text text-darken-3">StudyCenter</p>
               
                <p>공부하다가 지치면 눕고 싶다, 엎드려서 책읽고 싶다, 벽에 등 기대고 쉬고싶다, 여럿이 모여 의견을 공유하고 싶다 등등 다양한 욕구를 해소할 수 있는 공간입니다.

커튼과 가구 등 유동적인 도구들을 이용하여 필요에 따라 시선과 움직임을 조정할 수 있도록 한 것도 일반독서실과는 차별되는 특징이라 할 수 있습니다.</p> 
            </div>
            <div class="col s12" id="editing">
                <p class="flow-text amber-text text-darken-3">StudyRoom</p>
                <p>공부공간은 모두 반오픈형으로 일반책상보다 폭이 넓고 개인용 공간이 충분하도록 하였고 좌석별로 스탠딩 테이블을 추가하거나 
                개인용 책꽂이, 룸형식으로 조성하여 공부 방법에 변화를 줄 수 있는 특별한 공간으로 총 45석을 마련하였습니다.</p>
