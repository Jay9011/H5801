   ...
   <section class="container section scrollspy" id="intro">
      <div class="row">
          ...
          <div class="col s10 14">
              <h1 class="center-align pfont">JOIN CHECK</h1>
              <form action="joinEmail.ho" name="joinChkFrm" method="post">
                  ...
                  <section>
                      <div class="row">
                      <div class="input-field col s12 ">
                              <h6 class="center-align pfont">개인정보처리방침안내</h6>
                              <textarea readonly>
                        개요 및 목록
                
                        'HOLIC스터디 카페'는 (이하 '회사'는) 이용자님의 개인정보를 중요시하며,
                        ...
                        현 개인정보취급방침의 내용이 변경될 경우에는 개정 최소 7일전부터 홈페이지의 "공지사항"을 통해 고지 하겠습니다.
                              ...
                              <p class="pcolor">
                                  <label>
                                      <input type="checkbox" name="agree2" id="agree2" value="2" />
                                      <span>개인정보처리방침의 내용에 동의합니다.</span>
                                  </label>
                              </p>
                          </div>
                      </div>
              ...
              <div class="row">
                  <div class="col s12 14 center-align">
                      <button type="button" class="btn waves-effect" onclick="joinChk()">가입하기</button>
                  </div>
              </div>
          </div>
              <div class="col s1"></div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/JS/submit.js"></script> <!-- 유효성검사 -->
</body>
</html>