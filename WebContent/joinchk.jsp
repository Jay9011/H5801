...
<script type="text/javascript" src="JS/submit.js"></script> <!-- 유효성검사 -->
...
<section>
    ...
    <p><label for="agree1">회원가입약관의 내용에 동의합니다.</label><input type="checkbox" name="agree1" id="agree1" value="1"/></p>
</section>
<section>
    <h2>개인정보처리방침안내</h2>
    <textarea readonly>
   ...
   <p> <label for="agree2">개인정보처리방침안내의 내용에 동의합니다.</label><input type="checkbox" name="agree2" id="agree2" value="2"/></p>
   <p id="agreechk"></p>
</section>
</form>
<button type="button" onclick="joinChk()">가입하기</button>
</div>
</body>
</html>