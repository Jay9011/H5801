    ...
    <nav class="nav-wrapper" >
      <div class="container">
        ...
        <ul class="right hide-on-med-and-down Hnav">
          ...
          <li><a class="dropdown-trigger" data-target="dropdown2">고객 지원</a>
          ...
          <ul id='dropdown3' class='dropdown-content'>
            <li><a href="Mypage/">예약현황</a></li>
            <li><a href="Mypage/">게시물 조회</a></li>
            <li><a href="${pageContext.request.contextPath}/Mypage/reInfo.ho">정보수정</a></li>
          </ul>
        </li>
          <li>
              <button class="btn waves-effect waves-red btnIn"  onclick="location.href='${pageContext.request.contextPath}/User/login.ho'">로그인</button>
              <button style="display: none;" class="btn waves-effect waves-red btnOut" onclick="location.href='${pageContext.request.contextPath}/User/logout.ho'">로그아웃</button>
          </li>
